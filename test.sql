...
-- Tiempo de generación: 04-09-2017 a las 20:16:25
...
--
-- Estructura de tabla para la tabla `tbmaquinas`
--

CREATE TABLE `tbmaquinas` (
  `id` int(3) NOT NULL,
  `modo de operacion` varchar(10) NOT NULL,
  `tipo` varchar(10) NOT NULL,
  `fabricante` varchar(10) NOT NULL,
  `ID o serie fabricante` int(5) NOT NULL,
  `ano de fabricacion` int(4) NOT NULL,
  `numero de fases` int(3) NOT NULL,
  `potencia nominal` int(6) NOT NULL,
  `grado de proteccion IP` varchar(4) NOT NULL,
  `clase termica` varchar(4) NOT NULL,
  `tension nominal o de entrada` int(4) NOT NULL,
  `frecuencia nominal` int(4) NOT NULL,
  `corriente nominal` int(4) NOT NULL,
  `velocidad nominal` int(4) NOT NULL,
  `max sobrevelocidad` int(4) NOT NULL,
  `factor de potencia nominal` int(4) NOT NULL,
  `temperatura maxima` int(4) NOT NULL,
  `altura sobre el nivel del mar` int(4) NOT NULL,
  `peso de la maquina` int(4) NOT NULL,
  `dirección de giro` varchar(10) NOT NULL,
  `conexionado` varchar(20) NOT NULL,
  `ubicacion` varchar(20) NOT NULL,
  `propietario` varchar(20) NOT NULL,
  `Notas y comentarios` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
